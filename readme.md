SoccerBox is a Unity prefab for use with the VRChat Worlds SDK. It adds body colliders to players' avatars which allow them to kick, hit, and catch rigidbodies with their feet, knees, chest, and head.
